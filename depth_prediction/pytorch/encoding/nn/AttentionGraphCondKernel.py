...
class AttentionGraphCondKernel_2(nn.Module):
    def __init__(self, ms_featmaps, width=1024, norm_layer=BatchNorm2d, up_kwargs=None):
...
class AttentionGraphCondKernel_4(nn.Module):
    def __init__(self, ms_featmaps, width=256, norm_layer=BatchNorm2d, up_kwargs=None):
